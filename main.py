...
def attack(char_name: str, char_class: str) -> str:
    """Принимает имя и класс игрока, возвращает нанесенный урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Принимает имя и класс игрока, возвращает блокированный урон."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Принимает имя и класс игрока, возвращает специальное умение"""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Принимает имя и класс, возвращает описание игрока"""
    if char_class == 'warrior':
